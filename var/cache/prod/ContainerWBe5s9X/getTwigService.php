...
class getTwigService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bridge\Twig\Extension\AssetExtension(($container->privates['assets.packages'] ?? $container->load('getAssets_PackagesService')));
        ...
        $instance->addExtension(new \Nelmio\ApiDocBundle\Render\Html\GetNelmioAsset($c));
